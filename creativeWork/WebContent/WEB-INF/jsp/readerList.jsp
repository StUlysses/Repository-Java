...
<head>
<meta charset="UTF-8">
<title>${logined.username}的读者列表</title>
...
<script src="${pageContext.request.contextPath}/js/readerList.js"></script>
</head>
<body>
	<jsp:include page="./common/header.jsp"></jsp:include>
	<div style="width:70%;height:675px;margin-left:15%;margin-right:15%;border:1px blue solid">
		<h3 style="text-align:center">读者列表</h3>
		<c:forEach items="${readers}" var="i">
			<div>
